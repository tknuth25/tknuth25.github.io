...
# Determining Average for Players between 2000 and 2010 and played in at least 12 games
a_defense_df['G'].mean()
...
# Rating Calculation for 2000-2010 players with at least 12 games played
calc_list = ['a','b','c','d']
for i in calc_list:
...
# Defense Performance Statistics for Full Dataset
...
# Defense Coefficient Calculations
...
# Calculating Coefficients for Average Rating of 66.7 for subset that played at least 10 games in a season between 2000 and 2010
# a
...
# Rating Calculations for 2000 - 2010 subset with 12 games played in DL position Grouping
for i in calc_list:
...
# Overall DLine Performance Metric Calculations
...
# Overall DLine Coefficient Calculations
...
# Limiting to players that appeared in 10 Games and from 1999 Onward (due to TFL availability)
...
# Rating Calculations for 2000 - 2010 subset with 12 games played in LB position Grouping
for i in calc_list:
...
# Overall LB Performance Metric Calculations
for i in ['Player', 'Tm', 'Age', 'Pos', 'G', 'GS', 'Int', 'Int Yds', 'IntTD', 'Lng',
       'PD', 'FF', 'Fmb', 'FR', 'Fmb Yds', 'FRTD', 'Sk', 'combo_tkl', 'solo_tkl',
       'ast_tkl', 'tfl', 'qb_hits', 'safety', 'Year']:
...
# Rating Calculations for 2000 - 2010 subset with 12 games played in DB position Grouping
...
# Overall DB Performance Metric Calculations
for i in ['Player', 'Tm', 'Age', 'Pos', 'G', 'GS', 'Int', 'Int Yds', 'IntTD', 'Lng',
       'PD', 'FF', 'Fmb', 'FR', 'Fmb Yds', 'FRTD', 'Sk', 'combo_tkl', 'solo_tkl',
       'ast_tkl', 'tfl', 'qb_hits', 'safety', 'Year']:
...
# Overall DB Coefficient Calculations
