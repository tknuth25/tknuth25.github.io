...
for i in range(len(total_data1)):
    ...
    # Rushing and Passing Yard Field Differentiating (named the same in FB Reference Table)
    if i>15:
...
# Adjusting ratings over maximum threshold
calc_list = ['a','b','c','d']
...
# Confirming that average is 66.7 between 2000 and 2010
...
perfect_qb = a_qb_df.loc[a_qb_df['rating_adj']==158.3].copy()
b_qb_df = a_qb_df.loc[a_qb_df['Att']>=50].copy()

# Running Back Data Scrape
...
# Wide Receiver Performance Metrics
...
# Wide Receiver Rating Coefficients
# a
...
# Adjusting WR Maximum and Minimum Values
calc_list_2 = ['a','b','c']
...
# Limiting to 1992 onward to include years with full set of necessary metrics
...
# Assigning All-Pro and Pro Bowl Indicators
...
# Stacking Offense Data and Creating Subset of Players with Perfect Ratings in a Season
